...
def init_sub_args(args):
    ...
    args.ckpt_dir = '/checkpoints/ShanghaiTech_HR/'
...
def init_parser(default_data_dir='data/', default_exp_dir='data/exp_dir'):
    ...
    parser.add_argument('--dataset', type=str, default='ShanghaiTech',
                        choices=['ShanghaiTech', 'ShanghaiTech-HR', 'UBnormal', 'UBnormal-HR'], help='Dataset for Eval')
    ...
    parser.add_argument('--num_workers', type=int, default=6, metavar='W', help='number of dataloader workers (0=current thread) (default: 32)')
    ...
    parser.add_argument('--seg_len', type=int, default=None, metavar='SGLEN', help='Number of frames for training segment sliding window, a multiply of 6 (default: 12)')     
    ...
    parser.add_argument('--dataset_mix', nargs='+', default=None,help='List of datasets to mix for training. E.g. --dataset_mix SHT UBnormal')
    parser.add_argument('--eval_ubnormal_hr', action='store_true', help='Evaluate on HR version of UBnormal')
    # Model Params
    ...
    # parser.add_argument('--use_cil', action='store_true', help='Enable Clip-Independent Lambda adjustment')
