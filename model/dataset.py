...
from model.data_utils import normalize_pose
from model.pose_utils import gen_clip_seg_data_np, get_ab_labels
from torch.utils.data import DataLoader

SHANGHAITECH_HR_SKIP = [(1, 130), (1, 135), (1, 136), (6, 144), (6, 145), (12, 152)]
SCENE_SH = [0.22419157, 0.03344091, 0.00408572, 0.05643839 ,0.23434454 ,0.05268831,
 0.00755825 ,0.19793455 ,0.04310334 ,0.06790809 ,0.01830504 ,0.04983541,0.01016588]
SCENE_UB=[0.0127551 , 0.02786347 ,0.00931419, 0.00700047 ,0.03257 ,   0.03607024,
 0.04710489, 0.04303117, 0.04732242 ,0.03280731, 0.02780414 ,0.03351922,
 0.0856075 , 0.01839108 ,0.03581316, 0.02568818, 0.02400728, 0.03144281,
 0.05042715 ,0.0464523 , 0.04548331 ,0.05999842, 0.03007831, 0.03223382,
 0.03330169 ,0.03535833 ,0.03935295, 0.01969625 ,0.02950483]
...
class PoseSegDataset(Dataset):
    ...
    def __init__(self, path_to_json_dir, path_to_vid_dir=None, normalize_pose_segs=False, return_indices=False,
